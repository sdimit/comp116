1. 276 packets were present in set1.pcap
2. FTP
...
9. see files in this directory. Obtained by right clicking a data transfer packet > Follow Tcp Stream > Save As...
10. 74566 were present in set2.pcap
11. 5 plaintext logins
12. In **Wireshark**: searched for user/username/pass/password/login and their different variations, but that proved tedious (javascript in webpages contained those often). Because of this I decided to filter for unsecured protocols (http, pop3, ftp, telnet) and then inspected individual client/server conversations and searched for the above strings/looked at Follow TCP Stream. Lastly used **dsniff** to see if I've missed any logins...

13. Here's a table of all plain logins found:

    | # | User       | Password     | Protocol  | Source IP			       | Destination  IP / hostname  
    | --- | --- | --- | --- | --- | --- |
    | 1 | cisco      | chris10       | telnet   | 10.156.15.241:13247   | 200.60.17.1:23 
    | 2 | cisco      | chelita     | telnet      | 10.156.15.241:13247   | 200.60.17.1:23
    | 3 | cisco      | chayank     | telnet   | 10.156.15.241:13247   | 200.60.17.1:23
    | 4 | cisco      | cereza      | telnet     | 10.156.15.241:13247   | 200.60.17.1:23
    | 5 | cisco      | buburuza   | telnet    | 10.156.15.241:13247  | 200.60.17.1:23
    | 6 | e129286 | 4.Ekkama  | pop3    | 10.122.15.146:54630  | 144.122.144.179:110 arikanda.general.services.metu.edu.tr
    | 7 | brewer  | 1qazxsw209simona12 | pop3 |  10.124.15.238:49767 | 62.173.185.22:110 www.imartini.it 
    | 8 | mbergeson@hjnews.com | mb123on  |pop3 | 10.117.15.217:49795 | 67.128.149.178:110 mail.newswest.com
    
 > Seems like 200.60.17.1:23 is a cisco router, so there is no associated domain.
...
20. Most popular protocols obtained by selecting all the packets: *Edit > Mark All Displayed Packets*,
      and then opening *Statistics > Protocol Hierarchy Statistics...*
...
22. a list of various files being downloaded (given the protocol ranking and the fact it was mentioned in class 
that the network is unswitched e.g. ridiculously easy to sniff, this network was probably meant for 
? sharing reading materials ? security brochures)
  * someone sent somebody a "nervous face" *sticker* over facebook chat (・_・;)
